...
/**
 * V9 — COMPOSEUR : à partir du FORMAT réel détecté du cours (`format_profile`, V6), propose une
 * COMPOSITION pré-remplie que Ben n'a plus qu'à éditer (« [N] QCM + [M] ouvertes » pour un cours
