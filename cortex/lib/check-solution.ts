...
/**
 * Vérificateur perso : re-résout la question indépendamment puis compare à la réponse de l'étudiant.
 * Via le fournisseur LLM configuré. `imageRel` = chemin relatif au cwd d'une photo de la réponse.
 */
