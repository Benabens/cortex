...
/**
 * Mining de conversation : ce que l'étudiant demande à un assistant IA toute la journée
...
/** Analyse une conversation et en extrait des faiblesses structurées (via le fournisseur LLM configuré). */
