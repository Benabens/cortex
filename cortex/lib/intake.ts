...
/**
 * Détection du TYPE d'entrée texte de l'exo ciblé (au-delà de l'image).
 ...
 *
 * UNE passe LLM renvoie tout (kind + focus + faiblesses), pour ne pas multiplier les appels.
 */
...
/** Classe le texte d'entrée (1 appel LLM). Pour un texte court, renvoie directement subject. */
