...
/**
 * Provider par défaut (dev €0) : headless `claude -p` via l'abonnement Max.
...
export const claudeCodeProvider: LlmProvider = {
  ...
  unavailableReason(): string | null {
    return this.available()
      ? null
      : "Claude Code (binaire « claude ») introuvable. Installe-le et lance « claude » une fois pour te connecter à ton Max, puis réessaie (ou pose CORTEX_CLAUDE_BIN).";
  },
