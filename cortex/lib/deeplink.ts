...
/**
 * V10 — LIEN clic→source UNIFIÉ (corpus). Une seule logique partout (recherche, faiblesses,
 * /programme) → plus aucun lien périmé/404.
 *  - CS-202 (historique, validé) : HTML → viewer `/voir` (déplie + surligne) ; brut → `/sites/<anchor>`.
 *  - Autres cours (ML/CS-233, Algo/CS-250) : route course-aware `/csrc` (repli basename V8), PDF
