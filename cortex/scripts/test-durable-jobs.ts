/**
 * PREUVE « tue un worker en plein job → il reprend SANS PERTE ni doublon ».
 * Déterministe et gratuit (CORTEX_TEST_STUB_BATCH, aucun appel LLM) :
 *
...
(async () => {
  ...
  console.log(allOk
    ? "\n✅ OK : worker tué en plein job → requeue automatique, reprise au lot suivant, zéro perte, zéro doublon."
    : "\n❌ ÉCHEC");
