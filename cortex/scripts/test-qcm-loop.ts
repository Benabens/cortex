/** Preuve BOUCLE QCM FERMÉE : un « trop facile » sur un QCM change le bloc de calibration
 *  réinjecté à la génération suivante (avant/après). Déterministe (algo DB isolée, sans appel LLM). */
...
// L'utilisateur juge 3 QCM « trop faciles » (comme le ferait /api/qcm/[id]/grade avec un score haut)
...
console.log("\n" + (ok ? "✅ OK : 0 injection avant retour → après « trop facile », bloc de durcissement réinjecté à la conception ET à la critique des QCM." : "❌ ÉCHEC"));
process.exit(ok ? 0 : 1);
})();
