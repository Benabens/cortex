/** V8 P5 — preuve RÉSILIENCE : un lot qui « timeout » est ignoré, le job livre l'examen partiel ;
 *  zéro question → erreur claire (jamais de crash total). Déterministe (stub, sans Max). */
...
process.env.CORTEX_TEST_STUB_BATCH = "1"; // lots déterministes, aucun appel Max
...
(async () => {
  ...
  console.log(partialOk && cleanError ? "\n✅ P3 OK : partiel livré sans crash ; échec total = erreur claire réessayable." : "\n❌ P3 ÉCHEC");
