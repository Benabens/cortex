/**
 * CLI de détection de l'ADN D'EXAMEN d'un cours (générique, ré-entrant).
 *
 ...
 *
 * Preuve committée : data/refs/proof/moteur/dna-<course>.{json,md} — la distribution détectée
...
async function main() {
  ...
  console.log(`\nPreuve écrite : data/refs/proof/moteur/dna-${course}.{json,md}`);
  process.exit(0);
}
