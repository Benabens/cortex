...
- **Achat** : crédit provenant d'un paiement Stripe confirmé, identifié par la session de paiement (pack de 10, permanent).
- **Abonnement** (Pro) : seconde poche de crédits, rechargée chaque mois calendaire au montant du plan et jamais reportée ; une facture payée attribue le mois (idempotent par facture), l'annuel se recharge de mois en mois sans nouvelle facture. Un débit consomme l'abonnement avant les crédits achetés, dans la même réservation ; un remboursement rend chaque part dans sa poche, la part d'abonnement seulement si le mois n'a pas changé.
